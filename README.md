...
`rommulus-X.Y.Z-linux-x86_64.AppImage`, the portable tarball, and their checksums. Linux and
Steam Deck users should make the AppImage executable and add it directly as a Non-Steam Game.
Upload the AAB to Google Play and use the APK for direct Android installation.
