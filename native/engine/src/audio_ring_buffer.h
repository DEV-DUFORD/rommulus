...
// Consumer: the platform audio callback thread (via the registered
// romm::audio::AudioSink). This header is platform-neutral: it compiles
// with zero platform headers.
//
