...
class SearchViewModelTest {
    ...
    fun `toggle OFF preserves all search results including unsupported platforms`() {
        runBlocking {
            val repo = MockRepository()
            // 4 supported (gb) + 4 unsupported (genesis) = 8 total
            val mixedRoms = listOf(
                ...
                LibraryRom(id = 4, title = "Streets of Rage", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
    ...
    fun `toggle ON filters unsupported from paginated loadMore`() {
        runBlocking {
            ...
            val page1 = listOf(
                ...
                LibraryRom(id = 2, title = "Sonic 2", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 3, title = "Zelda LOR", platformDisplayName = "GBC", platformSlug = "gbc", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 4, title = "Phantasy Star", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
            ...
            val page2 = listOf(
                ...
                LibraryRom(id = 6, title = "NBA Jam", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
    ...
    fun `toggle ON with all unsupported results returns empty`() {
        runBlocking {
            ...
            val unsupportedOnly = listOf(
                LibraryRom(id = 1, title = "Sonic 2", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
    ...
    fun `pagination uses raw offset not filtered display size, no duplicate refetch`() {
        runBlocking {
            ...
            // Page 1: 4 items, 2 supported (gb) + 2 unsupported (genesis), total=8
            val page1 = listOf(
                LibraryRom(id = 1, title = "GB1", platformDisplayName = "GB", platformSlug = "gb", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 2, title = "Gen1", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 3, title = "GB2", platformDisplayName = "GBC", platformSlug = "gbc", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 4, title = "Gen2", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
            ...
            val page2 = listOf(
                ...
                LibraryRom(id = 6, title = "Gen3", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 7, title = "GB4", platformDisplayName = "GBC", platformSlug = "gbc", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 8, title = "Gen4", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
    ...
    fun `all unsupported pages progress via raw offset and eventually exhaust`() {
        runBlocking {
            ...
            val page1 = listOf(
                LibraryRom(id = 1, title = "Gen1", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 2, title = "Gen2", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
            // Page 2: all unsupported
            val page2 = listOf(
                LibraryRom(id = 3, title = "Gen3", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                LibraryRom(id = 4, title = "Gen4", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
            )
        ...
        runBlocking {
            ...
            repo.enqueue(LibraryResult.Success(RomPage(
                listOf(
                    ...
                    LibraryRom(id = 2, title = "G1", platformDisplayName = "Genesis", platformSlug = "genesis", coverUrl = null, lastPlayedIso = null, nowPlaying = false),
                ),
                total = 4,
            )))
