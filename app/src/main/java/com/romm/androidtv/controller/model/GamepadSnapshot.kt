...
data class GamepadSnapshot(
    ...
    companion object {
        ...
        private val DPAD_UP_DIR     = AxisDirection(MotionEvent.AXIS_Y, -1)
        private val DPAD_DOWN_DIR   = AxisDirection(MotionEvent.AXIS_Y,  1)
        private val DPAD_LEFT_DIR   = AxisDirection(MotionEvent.AXIS_X, -1)
        private val DPAD_RIGHT_DIR  = AxisDirection(MotionEvent.AXIS_X,  1)
        ...
        private fun applyAngleBasedDpad(
            ...
            // Obtain raw axis values (AXIS_X and AXIS_Y).
            val rawX = axisValues[MotionEvent.AXIS_X] ?: return
            val rawY = axisValues[MotionEvent.AXIS_Y] ?: return
            ...
            // Android AXIS_Y is screen-coordinates (positive = down), so we negate dy
            // to convert to standard math coordinates where positive Y = up. This ensures
            // pushing the stick up (negative rawY → negative deadzoned dy) maps to 90°.
